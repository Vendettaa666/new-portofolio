...
export default function ChatBubble({ avatar, name, time, message }: ChatBubbleProps) {
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-1.5 max-w-[95%] md:max-w-[90%] flex-1">
        {/* Header: Nama & Waktu */}
        ...
        {/* Bubble Chat */}
        <div className="bg-white w-full dark:bg-neutral-800/50 border border-neutral-200 dark:border-neutral-700 px-4 py-3 rounded-2xl rounded-tl-md shadow-sm group-hover:border-neutral-300 dark:group-hover:border-neutral-600 transition-all duration-200">
