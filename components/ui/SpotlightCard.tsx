...
const SpotlightCard = ({
  ...
  return (
    <div
      ...
      // default styles now respect both light and dark mode
      className={`relative rounded-3xl border border-neutral-200 bg-white dark:border-neutral-700 dark:bg-neutral-800 overflow-hidden p-8 ${className}`}
    >
      {children}
      <div
