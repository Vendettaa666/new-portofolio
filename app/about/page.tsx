  ...
  return (
    ...
    >
      <SpotlightCard 
        ...
        // ✅ PERBAIKAN: Gunakan tanda ! (important) untuk "memaksa" warna background dan border
        // agar gaya gelap bawaan SpotlightCard tertimpa sepenuhnya.
        className="w-full group flex flex-col sm:flex-row gap-4 sm:gap-5 rounded-2xl p-4 sm:p-5 overflow-hidden transition-all duration-300 !bg-neutral-50 dark:!bg-[#121212] border !border-neutral-200 hover:!border-neutral-400 dark:!border-neutral-800 dark:hover:!border-neutral-600" 
      > 
        <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-600 shadow-sm z-10 relative">
